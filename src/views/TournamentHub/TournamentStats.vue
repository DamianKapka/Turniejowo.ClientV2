<template>
    <v-data-table :headers="TableHeaders" :items="Statistics" class="elevation-7" :hide-actions="true" v-bind:pagination.sync="Pagination">
    ...
    created() {
        ...
        .then(response => {
            ...
            response.data.forEach(element => {
                statisticsTemp.push({name:`${element.fName} ${element.lName}`,team:element.team.name,points:element.points})
            });
